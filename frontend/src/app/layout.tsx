  ...
  return (
    <html lang="en">
      <body className="antialiased bg-[#030712] text-[#f9fafb] relative min-h-screen">
        {/* Aurora ambient glows — slow drift, GPU-composited */}
        <div className="aurora-blob fixed top-0 right-0 w-[500px] h-[500px] bg-indigo-600/10 rounded-full blur-[120px] pointer-events-none -z-10" />
        <div className="aurora-blob fixed top-[30%] -left-[100px] w-[600px] h-[600px] bg-violet-600/5 rounded-full blur-[150px] pointer-events-none -z-10 [animation-delay:-6s]" />
        <div className="aurora-blob fixed bottom-0 right-[-100px] w-[500px] h-[500px] bg-cyan-600/5 rounded-full blur-[120px] pointer-events-none -z-10 [animation-delay:-12s]" />
